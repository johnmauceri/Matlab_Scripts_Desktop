...
for i = 1:2
    ...
    for loop = filename'
        ...
        for n = 1: sz(2)
            ...
            if i==1
                fn = fullfile(dirDest, strcat('Can_',INFO.SeriesDescription, int2str(cnt), '_', int2str(n), '.jpg'));
            else
                fn = fullfile(dirDest, strcat('Ben_',INFO.SeriesDescription, int2str(cnt), '_', int2str(n), '.jpg'));
            end
