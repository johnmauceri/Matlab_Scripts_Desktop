...
function [xy_long max_angl min_angl] = muscle_finder_test(I, file, DEBUG)
xy_long = 0;
xy_cr = 0;
max_angl_err = 0;
...
if (DEBUG>=1) figure(8); imagesc(BW4);colormap gray; end;
...
while (mt < 1.0)
    BW1 = BW > mt;
    if (DEBUG>=1) figure(7); imagesc(BW1);colormap gray; end;
...
if (DEBUG>=1) h = figure(5); subplot(1,2,1); imagesc(I); colormap gray;  axis equal tight; subplot(1,2,2); imagesc(I); colormap gray;  hold on; axis equal tight; end
max_len = 0;
max_cr = 0;
len_of_cr = 0;
cr_of_len = 0;
