...
for db=2
    ...
    %Implants
    store_i1 = ...
        [15 15 15 15 15 41 41 41 41 41 41 41 41 41 41 41 41 41 55 96 96 96 138 138 138 138 140 140 168 168 182 182 182 189 189 ...
    ...
    store_i2 = ...
        [ 8  9 10 11 12  3  5  6  7  8 11 12 13 14 18 19 20 21  5  5  6  7   3   4   5   6  13  16   5   8   3   4   7   3   4 ...
   ...
   found = 99;                
                    if (found >= 4)
                        ...
                        BW2=(imdilate(double(Iboundary),ones(200)));
                        ...
                        %if (DEBUG >= 1) figure; imagesc(BW); colormap gray; end
                        BW = (imdilate(double(BW==1),ones(5)));
