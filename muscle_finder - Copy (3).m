...
while (mt < 1.0)
    ...
    %if ((nnz(BW1(cleav_y_sm(1):cleav_y_sm(2),cleav_x_sm(1):cleav_x_sm(2)))/prod(size(BW1(cleav_y_sm(1):cleav_y_sm(2),cleav_x_sm(1):cleav_x_sm(2))))) < PERCENT_WHITE) break; end;
...
if (DEBUG>=1) h = figure(4); imagesc(I); colormap gray; hold on; end;
max_len = 0;
min_angl = 90;
max_angl = 0;
